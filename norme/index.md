...
<span class="prose__kicker">Titolo IV — Osservatorio civico</span>
<h1>Delle norme</h1>

<p>Quante leggi vigono in Italia, come sono distribuite per settore, e dove la Costituzione entra in conflitto con se stessa. Dati, fonti e giurisprudenza della Corte Costituzionale e della Corte Europea dei Diritti dell'Uomo.</p>
...
<nav aria-label="Sezioni" style="margin:28px 0 36px;padding:14px 18px;background:rgba(31,44,66,0.05);border-radius:4px;">
  ...
  <ol style="margin:0;padding-left:18px;font-size:15px;line-height:2;">
    ...
    <li><a href="#tensioni">Tensioni interne alla Costituzione</a></li>
    <li><a href="#caso-famiglia">Caso studio: famiglia e diritti</a></li>
    <li><a href="#corte-edu">Il ruolo della Corte EDU</a></li>
    <li><a href="#dibattito">Matrimonio e unioni civili: le posizioni</a></li>
    <li><a href="#fonti">Fonti e riferimenti</a></li>
  </ol>
</nav>
...
<tr style="border-bottom:1.5px solid var(--line);">
  <th style="text-align:left;padding:8px 12px;font-family:var(--font-mono);font-size:13px;color:var(--navy);">Paese</th>
  <th style="text-align:right;padding:8px 12px;font-family:var(--font-mono);font-size:13px;color:var(--navy);">Norme stimate</th>
  <th style="padding:8px 12px;font-family:var(--font-mono);font-size:13px;color:var(--navy);">Affidabilità stima</th>
</tr>
</thead>
<tbody>
<tr style="border-bottom:1px solid var(--line-soft);"><td style="padding:7px 12px;">Italia</td><td style="text-align:right;padding:7px 12px;font-family:var(--font-mono);">~160.000</td><td style="padding:7px 12px;color:var(--ink-soft);">Media</td></tr>
<tr style="border-bottom:1px solid var(--line-soft);"><td style="padding:7px 12px;">Francia</td><td style="text-align:right;padding:7px 12px;font-family:var(--font-mono);">~80.000</td><td style="padding:7px 12px;color:var(--ink-soft);">Alta</td></tr>
<tr style="border-bottom:1px solid var(--line-soft);"><td style="padding:7px 12px;">Spagna</td><td style="text-align:right;padding:7px 12px;font-family:var(--font-mono);">~70.000</td><td style="padding:7px 12px;color:var(--ink-soft);">Media</td></tr>
<tr style="border-bottom:1px solid var(--line-soft);"><td style="padding:7px 12px;">Austria</td><td style="text-align:right;padding:7px 12px;font-family:var(--font-mono);">~40.000</td><td style="padding:7px 12px;color:var(--ink-soft);">Alta</td></tr>
<tr style="border-bottom:1px solid var(--line-soft);"><td style="padding:7px 12px;">Germania</td><td style="text-align:right;padding:7px 12px;font-family:var(--font-mono);">~30.000</td><td style="padding:7px 12px;color:var(--ink-soft);">Alta</td></tr>
<tr style="border-bottom:1px solid var(--line-soft);"><td style="padding:7px 12px;">Paesi Bassi</td><td style="text-align:right;padding:7px 12px;font-family:var(--font-mono);">~25.000</td><td style="padding:7px 12px;color:var(--ink-soft);">Alta</td></tr>
<tr style="border-bottom:1px solid var(--line-soft);"><td style="padding:7px 12px;">Svezia</td><td style="text-align:right;padding:7px 12px;font-family:var(--font-mono);">~22.000</td><td style="padding:7px 12px;color:var(--ink-soft);">Alta</td></tr>
<tr style="border-bottom:1px solid var(--line-soft);"><td style="padding:7px 12px;">Danimarca</td><td style="text-align:right;padding:7px 12px;font-family:var(--font-mono);">~12.000</td><td style="padding:7px 12px;color:var(--ink-soft);">Alta</td></tr>
<tr><td style="padding:7px 12px;">Estonia</td><td style="text-align:right;padding:7px 12px;font-family:var(--font-mono);">~8.000</td><td style="padding:7px 12px;color:var(--ink-soft);">Alta</td></tr>
</tbody>
</table>
</div>
...
<thead>
<tr style="border-bottom:1.5px solid var(--line);">
  <th style="text-align:left;padding:8px 12px;font-family:var(--font-mono);font-size:13px;color:var(--navy);">Settore</th>
  <th style="text-align:right;padding:8px 12px;font-family:var(--font-mono);font-size:13px;color:var(--navy);">Norme stimate</th>
  <th style="padding:8px 12px;font-family:var(--font-mono);font-size:13px;color:var(--navy);">Complessità</th>
</tr>
</thead>
<tbody>
...
<div class="callout">
  <strong>Art. 3 c.1:</strong> «Tutti i cittadini hanno pari dignità sociale e sono eguali davanti alla legge, senza distinzione di sesso, di razza, di lingua, di religione, di opinioni politiche, di condizioni personali e sociali.»
</div>
